...
// ==================== QR CODE (PayPal Payment Links & Buttons API) ====================
// Per doc: https://docs.paypal.ai/payments/pay-links-buttons-api
...
app.post('/create-qr', async (req, res) => {
  try {
    ...
    // Step 2: Create a payment link via PayPal Payment Links & Buttons API
    ...
    // Step 3: Generate QR code from the official PayPal payment_link URL
